...
MAKE NO REPRESENTATIONS OR WARRANTIES REGARDING THE ACCURACY, RELIABILITY, OR
COMPLETENESS OF THE SOFTWARE OR ANY DATA IT PRODUCES.
...
USE OR OTHER DEALINGS IN THE SOFTWARE. THIS INCLUDES, WITHOUT LIMITATION,
...
The Software is a developer tool and does not provide legal, security, or
professional advice. You should independently verify any actions the Software
takes against your ServiceNow instances or other systems.

## 8. Indemnification

You agree to indemnify and hold harmless the authors and contributors from any
claims, damages, losses, or expenses (including reasonable legal fees) arising
from your use of the Software or your violation of these terms.
