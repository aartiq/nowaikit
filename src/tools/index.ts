...
const PACKAGE_TOOL_NAMES: Record<string, string[]> = {
  ...
  system_administrator: [
    ...
    'create_indicator', 'update_indicator',
    'list_indicator_sources', 'get_indicator_source', 'create_indicator_source', 'update_indicator_source',
    'list_pa_breakdowns', 'get_pa_breakdown', 'create_breakdown', 'update_breakdown',
    'create_breakdown_source', 'create_breakdown_mapping',
    'list_pa_dashboards', 'get_pa_dashboard', 'create_dashboard', 'update_dashboard',
    'list_par_dashboards', 'get_par_dashboard', 'create_par_dashboard', 'update_par_dashboard',
    'add_par_dashboard_tab', 'add_par_dashboard_widget', 'remove_par_dashboard_widget',
    'list_oauth_applications', 'list_credential_aliases',
